...
$apple = new Insertion_Bdd(
    ...
    $apple->set_sql('UPDATE `root`.`information_user` SET `information_user_name_1` = "'.$liste_projet_admin_name1.'", `information_user_name_2`="'.$liste_projet_admin_name2.'" WHERE `information_user_id` = "'.$liste_projet_admin_id_sha1.'"') ; 
