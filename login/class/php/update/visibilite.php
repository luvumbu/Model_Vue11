...
$liste_projet_admin_visibilite1 = $_POST["liste_projet_admin_visibilite1"] ; 
...
$apple = new Insertion_Bdd(
      ...
      $apple->set_sql('UPDATE `liste_projet_admin` SET `liste_projet_admin_visibilite1` = "'.$liste_projet_admin_visibilite1.'"     WHERE `liste_projet_admin_id_sha1` = "'.$liste_projet_admin_id_sha1.'"') ; 
