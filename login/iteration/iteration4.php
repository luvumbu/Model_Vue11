<?php 
    ...
    $apple_iteration_4->sql = 'SELECT * FROM `liste_projet_admin` WHERE `liste_projet_admin_id_sha1_general`!="remove" AND `liste_projet_admin_id_parent` ="' .$iteration4_x . '" ';
    ...
    $liste_projet_admin_description1_iteration_4 = $apple_iteration_4->add_array_element($number_iteration_4);
    $number_iteration_4++;

    $liste_projet_admin_description2_iteration_4 = $apple_iteration_4->add_array_element($number_iteration_4);
    $number_iteration_4++;

    $liste_projet_admin_description3_iteration_4 = $apple_iteration_4->add_array_element($number_iteration_4);
    $number_iteration_4++;

    $liste_projet_admin_description4_iteration_4 = $apple_iteration_4->add_array_element($number_iteration_4);
    $number_iteration_4++;

    $liste_projet_admin_visibilite1_iteration_4 = $apple_iteration_4->add_array_element($number_iteration_4);
    $number_iteration_4++;

    $liste_projet_admin_visibilite2_iteration_4 = $apple_iteration_4->add_array_element($number_iteration_4);
    $number_iteration_4++;


    $liste_projet_admin_visibilite3_iteration_4 = $apple_iteration_4->add_array_element($number_iteration_4);
    $number_iteration_4++;

    $liste_projet_admin_visibilite4_iteration_4 = $apple_iteration_4->add_array_element($number_iteration_4);
    $number_iteration_4++;

    $liste_projet_admin_visite_page_iteration_4 = $apple_iteration_4->add_array_element($number_iteration_4);
    $number_iteration_4++;

    $liste_projet_admin_type_iteration_4 = $apple_iteration_4->add_array_element($number_iteration_4);
    $number_iteration_4++;

    $information_user_id_sha1_iteration_4 = $apple_iteration_4->add_array_element($number_iteration_4);
    $number_iteration_4++;

    $liste_projet_admin_new_file_iteration_4 = $apple_iteration_4->add_array_element($number_iteration_4);
    $number_iteration_4++;

    $liste_projet_admin_remove_iteration_4 = $apple_iteration_4->add_array_element($number_iteration_4);
    $number_iteration_4++;

    $liste_projet_date_iteration_4 = $apple_iteration_4->add_array_element($number_iteration_4);
    $number_iteration_4++;

    $liste_projet_last_update_iteration_4 = $apple_iteration_4->add_array_element($number_iteration_4);
    $number_iteration_4++;

    $liste_projet_reg_date_iteration_4 = $apple_iteration_4->add_array_element($number_iteration_4);
    $number_iteration_4++;
    ...
    $liste_projet_admin_display_iteration_4 = $apple_iteration_4->add_array_element($number_iteration_4);
    $number_iteration_4++;
...
if($liste_projet_admin_visibilite1_iteration_4[$iteration_4x]==""){
      $mot_d_origine1 = '';
      ...
      echo '<div id="'.$liste_projet_admin_id_sha1_iteration_4[$iteration_4x].'" class="iteration2_0 iterationimg_all">';
      ...
      echo "<br>";
      $apple__ = new Get_anne($liste_projet_reg_date_iteration_4[$iteration_4x]);
    ...
    <img src="../add_picture/<?php echo $liste_projet_admin_new_file_iteration_4[$iteration_4x]?>" alt="" srcset="">
        ...
        echo '</div>';
      $iteration4_x=$liste_projet_admin_id_sha1_iteration_4[$iteration_4x] ;      
